...
class RBContentView: UIScrollView {
  ...
  override init(frame: CGRect) {
    ...
    contentViewWidthConstraint = NSLayoutConstraint(
      item: contentView,
      attribute: .width,
      relatedBy: .equal,
      toItem: nil,
    ...
    let verticalConstraints = NSLayoutConstraint.constraints(
      withVisualFormat: "V:|[contentView(==mainView)]|",
      options: [],
      metrics: nil,
      views: ["contentView": contentView, "mainView": self])
  ...
  func addContentView(_ view: UIView, frame: CGRect) {
    ...
    if contentViews.count > 0 {
      ...
      let horizontalConstraints = NSLayoutConstraint.constraints(
        withVisualFormat: "H:[previousView]-0-[view]",
        options: [],
...
extension RBContentView: UIScrollViewDelegate {
  ...
  func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
    ...
    NotificationCenter.default.post(
      name: Notification.Name(rawValue: "DidChangeSegmentIndex"),
      object: pageIndex)
  }
}
