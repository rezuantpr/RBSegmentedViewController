...
class RBSegmentView: UIScrollView {
    ...
    required override init(frame: CGRect) {
		...
		NotificationCenter.default.addObserver(self,
		                                       selector: #selector(RBSegmentView.didChangeSegmentIndex(_:)),
    ...
    func getSegmentTabForController(_ controller: UIViewController) -> RBSegmentTab {

		var segmentTab: RBSegmentTab?

		if controller.navigationItem.titleView != nil {
			segmentTab = RBSegmentTab.init(view: controller.navigationItem.titleView!)
		} else {

			if let title = controller.title {
				segmentTab = RBSegmentTab.init(title: title)
			} else {
				segmentTab = RBSegmentTab.init(title: "")
			}
