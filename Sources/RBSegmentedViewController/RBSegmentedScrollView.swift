...
class RBSegmentedScrollView: UIScrollView {
  
  var segmentView: RBSegmentView?
  ...
  var rbShowsVerticalScrollIndicator: Bool = false {
    didSet {
      showsVerticalScrollIndicator = rbShowsVerticalScrollIndicator
      contentView?.showsVerticalScrollIndicator = rbShowsVerticalScrollIndicator
    }
  }
  
  var rbShowsHorizontalScrollIndicator: Bool = false  {
    didSet {
      showsHorizontalScrollIndicator = rbShowsHorizontalScrollIndicator
      contentView?.showsHorizontalScrollIndicator = rbShowsHorizontalScrollIndicator
    }
  }
  
  private var viewObservers = [UIView]()
  
  var rbDisableScrollOnContentView: Bool = false {
    didSet {
      contentView?.isScrollEnabled = !rbDisableScrollOnContentView
    }
  }
  ...
  func addSegmentView(_ controllers: [UIViewController], frame: CGRect) {
    ...
    if controllers.count > 1 {
      ...
      segmentView = RBSegmentView(frame: CGRect.zero)
  ...
  func addSegmentsForContentViews(_ titles: [String]) {
    ...
    segmentView = RBSegmentView(frame: frame)
  ...
  func createContentView() -> RBContentView {
    
    let contentView = RBContentView(frame: CGRect.zero)
    contentView.showsVerticalScrollIndicator = rbShowsVerticalScrollIndicator
    contentView.showsHorizontalScrollIndicator = rbShowsHorizontalScrollIndicator
    contentView.isScrollEnabled = !rbDisableScrollOnContentView
