...
@objc public protocol RBSegmentedViewControllerDelegate {
   ...
   */
  @objc optional func didMoveToPage(_ controller: UIViewController, segment: RBSegmentTab?, index: Int)
}

/**
 *  Public protocol of  RBSegmentedViewController for content changes and makes the scroll effect.
 */
@objc public protocol RBSegmentedViewControllerViewSource {
  
  /**
   By default, RBSegmentedScrollView will observe the default view of viewcontroller for content
   changes and makes the scroll effect. If you want to change the default view, implement
   RBSegmentedViewControllerViewSource and pass your custom view.
 ...
 */
@objc open class RBSegmentedViewController: UIViewController {
   ...
   */
  open var segmentShadow = RBShadow() {
    didSet {
   ...
   */
  open var segments: [RBSegmentTab] {
    get {
  ...
  open var showsVerticalScrollIndicator = true {
    didSet {
      segmentedScrollView.rbShowsVerticalScrollIndicator = showsVerticalScrollIndicator
    }
  }
  ...
  open var showsHorizontalScrollIndicator = true {
    didSet {
      segmentedScrollView.rbShowsHorizontalScrollIndicator = showsHorizontalScrollIndicator
    }
  }
  ...
  open var disableScrollOnContentView: Bool = false {
    didSet {
      segmentedScrollView.rbDisableScrollOnContentView = disableScrollOnContentView
    }
  }
  
  open weak var delegate: RBSegmentedViewControllerDelegate?
  var segmentedScrollView = RBSegmentedScrollView(frame: CGRect.zero)
  ...
  override open func viewDidLayoutSubviews() {
    ...
    let topSpacing = RBUtil.getTopSpacing(self)
    segmentedScrollView.topSpacing = topSpacing
    segmentedScrollView.bottomSpacing = RBUtil.getBottomSpacing(self)
  ...
  func addSegmentedScrollView() {
    ...
    let bottomSpacing = RBUtil.getBottomSpacing(self)
  ...
  func addContentControllers(_ contentControllers: [UIViewController]) {
    ...
    for controller in contentControllers {
      ...
      let delegate = controller as? RBSegmentedViewControllerViewSource
